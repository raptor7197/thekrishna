...
const Setup = () => {
  const devices = [
    ...
    }, 
    {
      ...
      review: 'lasting strong from 7+ years ',
    },
    {
  ...
  const extensions = [
    ...
    { name: 'React Developer Tools', url: 'https://reactjs.org/', review: 'Essential for React debugging. Can\'t live without it.' },
      ...
      <div className="setup-container">
        ...
        <section className="quote-section">
          <blockquote className="quote">
            ...
            <cite>— Sung Jin-Woo, Solo Leveling</cite>
          </blockquote>
        </section>
      </div>
    </div>
