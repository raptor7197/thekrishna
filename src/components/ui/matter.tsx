...
export function GenerativeArtScene() {
  ...
  return <div ref={mountRef} className="matter-canvas-container" />;
}

export function AnomalousMatterHero({ className = "" }) {
  return (
    <section role="banner" className={`matter-hero ${className}`}>
      <Suspense
        fallback={
          <div
            className="matter-canvas-container"
      ...
      <div className="matter-gradient-overlay" />
    </section>
  );
}
